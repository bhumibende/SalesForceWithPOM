...
//	}
	...
	public void WaitUntilPresenceOfElementLocatedBy(WebElement ele, String objName) {
		
		//WebElement ele  = driver.findElement(locator);
		WebDriverWait webDriverWait = new WebDriverWait(driver, Duration.ofSeconds(10));
		
		webDriverWait.until(d->ele.isDisplayed());
		System.out.println("Waiting");
	...
	public void waitUntilElementToBeClickable(WebElement ele, int time) {
		WebDriverWait webDriverWait = new WebDriverWait(driver, Duration.ofSeconds(time));
		
		webDriverWait.until(d->ele.isEnabled());
		System.out.println("Waiting");
	}
